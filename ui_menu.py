...
window = Tk()
frame_tit = Frame(window, width=350, height=600, bg="white")
frame_tit.pack()
...
imglabel = Label(frame_tit, width=175, height=100, bg="white").place(x=165, y=0)  
...
imglabel = Label(frame_men, width=350, height=519, bg="lightgreen").place(x=-2, y=-2)
...
button_total = Button(frame_men, text="REGISTRO", font=("Century Gothic", "11", "bold"), command=tabla)
button_total.place(x=135, y=430)
